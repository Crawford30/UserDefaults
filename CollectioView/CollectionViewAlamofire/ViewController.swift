...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        checkForFavourites() //checking for favourites in the user defaults - BEFORE enabling/disabling button
    ...
    func fetchServicesFromCategory(_ theURL: String ) {
        ...
        Alamofire.request( theURL, method: .get ).responseJSON { (response) in
            ...
            for serviceData in dictServiceData {
                ...
                // tempID = Services.init(serviceID: serviceData["id"] as! Int , categoryID: 0, desc: "", title: serviceData["name"] as! String, image: serviceData["image"] as! String)
...
//🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷🔷
    ...
    //⚙️⚙️⚙️⚙️  SUPPORT FOR SAVING AND LOADING FAVOURITES  ⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️
    ...
    func saveFavourites() {
        ...
        do {
            ...
            let encodedData = try NSKeyedArchiver.archivedData(withRootObject: favouritesArray, requiringSecureCoding: false)
            
            defaults.set( encodedData, forKey: keyForFavourites )
    ...
    func checkForFavourites() {
        ...
        if defaults.object(forKey: keyForFavourites ) == nil {  // Return if no Favourites saved
        ...
        do {
            ...
            let decodedData = UserDefaults.standard.object(forKey: keyForFavourites ) as! Data

            favouritesArray = try NSKeyedUnarchiver.unarchiveTopLevelObjectWithData( decodedData ) as! [Services]
            
        } catch {

            print("Problem decoding Favorites")

        }

    }
    
    //⚙️⚙️⚙️⚙️  END OF SUPPORT FOR SAVING AND LOADING FAVOURITES  ⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️⚙️
